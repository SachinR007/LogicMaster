    ...
    <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
      ...
      <span class="ml-3 text-xl" style="color: white; font-size: 2em">LogicMaster</span>
        ...
        <nav class="text-white text-base font-semibold pt-3">
             <a href="allQuestions.jsp" class="flex items-center text-white active-nav-link py-4 pl-6 nav-item">
              All Questions
            </a>   
  ...
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <div class="relative text-sm">
                        <button id="userButton" class="flex items-center focus:outline-none mr-3">
                         ...
                         <div id="userMenu" class="bg-white rounded shadow-md mt-2 absolute mt-12 top-0 right-0 min-w-full overflow-auto z-30 invisible" style="">
                            <ul class="list-reset" >
...
<h1 style="font-size: 30px; text-align: center;">MY QUESTIONS</h1><br>

<%
int uId=(Integer)session.getAttribute("uId");
QuestionDAOImpl dao=new QuestionDAOImpl();
List<Object> questions= dao.getQuestionByUId(uId);
int count=0;
...
%>
<h2 style="font-size: 20px;">Ques <%=count %>) <%=question.getValue() %></h2>
<FORM ACTION="answers.jsp" METHOD="GET">	
<input type="hidden" name=queId value=<%=question.getQueId() %>>
<button class="inline-flex items-center bg-gray-200 border-0 py-1 px-3 focus:outline-none hover:bg-gray-300 rounded text-base mt-4 md:mt-0" >Answers
      <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-1" viewBox="0 0 24 24">
        <path d="M5 12h14M12 5l7 7-7 7"></path>
      </svg>
    </button>
