                        ...
                        <button id="userButton" class="flex items-center focus:outline-none mr-3">
                         ...
                         <div id="userMenu" class="bg-white rounded shadow-md mt-2 absolute mt-12 top-0 right-0 min-w-full overflow-auto z-50 invisible" style=" ">
                            <ul class="list-reset" >
                                ...
                                <li><a href="logout.jsp" class="px-4 py-2 block text-gray-900 hover:bg-gray-400 no-underline hover:no-underline" onclick="myFunction()">Logout</a></li>
                            </ul>
                        </div> 
                    </div>
  </div>
...
List<Object> questions=dao.allQuestions();
int count=0;
for(Object o:questions)
{
  Question question = (Question)o;
  
  int queId=question.getQueId();
  User user= question.getUser();
  String name=user.getuName();
  String value=question.getValue();
  count++;
%>
<h2 style="font-size: 20px;">Q<%=count %>) <%=value %></h2>
<h2 style="font-size: 15px; text-align: right;">Asked by : <%=name %></h2>
<br>
<div style="padding-left: 60px;">
<FORM ACTION="answers.jsp" METHOD="GET">  
<input type="hidden" name=queId value=<%=queId %>>
&emsp;&emsp;&emsp;&emsp;<button class="inline-flex items-center bg-gray-200 border-0 py-1 px-3 focus:outline-none hover:bg-gray-300 rounded text-base mt-4 md:mt-0"  >Answers
      <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-1" viewBox="0 0 24 24">
        <path d="M5 12h14M12 5l7 7-7 7"></path>
      </svg>
    </button>
