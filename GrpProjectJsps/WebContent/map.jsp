...
<body class="bg-gray-100 font-family-karla flex body">
    ...
    <aside class="relative bg-sidebar h-10 w-65 hidden sm:block shadow-xl" style=" height: 625px; overflow-y:scroll;">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="map.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
               MAP
            </a>
...
<!-- Another Header -->
 ...
 -->
        ...
        <header x-data="{ isOpen: false }" class="w-65 bg-sidebar py-5 px-6 sm:hidden">
            ...
            <h1 class="text-3xl text-black pb-6" style="font-size: 50px ;font-family:sans-serif; color: #50006b">Java - The Map Interface</h1>  <!-- This is the Heading section.. dont do any changes except changing the heading-->

            <iframe width="560" height="315" src="https://www.youtube.com/embed/uu20xO9AaU4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/uu20xO9AaU4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			...
			<ul >
			<li><p>Given a key and a value, you can store the value in a Map object. After the value is stored, you can retrieve it by using its key.</p></li>
			<li><p>Several methods throw a NoSuchElementException when no items exist in the invoking map.</p></li>
			<li><p>A ClassCastException is thrown when an object is incompatible with the elements in a map.</p></li>
			<li><p>A NullPointerException is thrown if an attempt is made to use a null object and null is not allowed in the map.</p></li>
			<li><p>An UnsupportedOperationException is thrown when an attempt is made to change an unmodifiable map.</p></li>
			</ul>
			<br><br>
			<table >
			<tr>
			...
			<tr>
			<td >1</td>
			<td><p><b>void clear( )</b></p>
			<p>Removes all key/value pairs from the invoking map.</p>
			</td>
			</tr>
			<tr>
			<td>2</td>
			<td><p><b>boolean containsKey(Object k)</b></p>
			<p>Returns true if the invoking map contains <b>k</b> as a key. Otherwise, returns false.</p>
			</td>
			</tr>
			<tr>
			<td >3</td>
			<td><p><b>boolean containsValue(Object v)</b></p>
			<p>Returns true if the map contains <b>v</b> as a value. Otherwise, returns false.</p>
			</td>
			</tr>
			<tr>
			<td>4</td>
			<td><p><b>Set entrySet( )</b></p>
			<p>Returns a Set that contains the entries in the map. The set contains objects of type Map.Entry. This method provides a set-view
			of the invoking map.</p>
			</td>
			</tr>
			<tr>
			<td>5</td>
			<td><p><b>boolean equals(Object obj)</b></p>
			<p>Returns true if obj is a Map and contains the same entries. Otherwise, returns false.</p>
			</td>
			</tr>
			<tr>
			<td >6</td>
			<td><p><b>Object get(Object k)</b></p>
			<p>Returns the value associated with the key <b>k</b>.</p>
			</td>
			</tr>
			<tr>
			<td >7</td>
			<td><p><b>int hashCode( )</b></p>
			<p>Returns the hash code for the invoking map.</p>
			</td>
			</tr>
			<tr>
			<td >8</td>
			<td><p><b>boolean isEmpty( )</b></p>
			<p>Returns true if the invoking map is empty. Otherwise, returns false.</p>
			</td>
			</tr>
			<tr>
			<td >9</td>
			<td><p><b>Set keySet( )</b></p>
			<p>Returns a Set that contains the keys in the invoking map. This method provides a set-view of the keys in the invoking map.</p>
			</td>
			</tr>
			<tr>
			<td >10</td>
			<td><p><b>Object put(Object k, Object v)</b></p>
			<p>Puts an entry in the invoking map, overwriting any previous value associated with the key. The key and value are k and v, respectively. Returns null if the key did not already exist. Otherwise, the previous value linked to the key is returned.</p>
			</td>
			</tr>
			<tr>
			<td >11</td>
			<td><p><b>void putAll(Map m)</b></p>
			<p>Puts all the entries from <b>m</b> into this map.</p>
			</td>
			</tr>
			<tr>
			<td>12</td>
			<td><p><b>Object remove(Object k)</b></p>
			<p>Removes the entry whose key equals <b>k</b>.</p>
			</td>
			</tr>
			<tr>
			<td >13</td>
			...
			<tr>
			<td >14</td>
			<td><p><b>Collection values( )</b></p>
			<p>Returns a collection containing the values in the map. This method provides a collection-view of the values in the map.</p>
			</td>
			</tr>
			</table>
			...
			<h2><b>Example</b></h2>
			<br>
			<p>Map has its implementation in various classes like HashMap. Following is an example to explain map functionality &minus;</p>
			<div >
			<a href="http://tpcg.io/fddETn" target="_blank" class="demo" rel="nofollow"><i class="fa-external-link"></i> Live Demo</a>
			</div>
            ...
            <a href="queue.jsp"> <button class="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg" >Previous page</button></a>
            <a href="exceptions.jsp"><button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="float: right;">Next page</button></a>
