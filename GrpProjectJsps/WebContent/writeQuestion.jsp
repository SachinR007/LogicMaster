    ...
    <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
      ...
      <span class="ml-3 text-xl" style="color: white; font-size: 2em">LogicMaster</span>
        ...
        <nav class="text-white text-base font-semibold pt-3">
             ...
             <a href="writeQuestion.jsp" class=" flex items-center text-white active-nav-link py-4 pl-6 nav-item">
              Ask Question
            </a>
            <a href="getSearch.jsp" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
              Search Question
            </a>
 ...
 -->
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6 main">
            <!-- Writing area -->
<br>
<h1 style="font-size: 30px; text-align: center;">ask question</h1><br>
<form action="WriteQuestionServ" method="get">
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Write Question<br><br>
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<textarea rows="10" cols="70" name=value></textarea><br><br>
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<button class="inline-flex items-center bg-gray-200 border-0 py-1 px-3 focus:outline-none hover:bg-gray-300 rounded text-base mt-4 md:mt-0" >Submit
      <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-1" viewBox="0 0 24 24">
        <path d="M5 12h14M12 5l7 7-7 7"></path>
      </svg>
    </button>
