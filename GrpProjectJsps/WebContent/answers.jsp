...
<h1 style="font-size: 30px; text-align: center;">FORUM ANSWERS</h1>
<%
...
List<Object> answer=impl.allAnswers(question);
int count=0;
%>
<br><b><h1 style="font-size: 20px;"><%=value %></h1></b><br>
<%
for(Object o:answer)
{
	Answer a=(Answer)o;
...
<p style="font-size: 20px;">Answer <%=count%>) <%=a.getValue() %></p><br><p style="font-size: 15px; text-align: right;">Answered by : <%=name %></p>
<%
}
%>
<H2 style="font-size: 20px;">SUBMIT YOUR ANSWER</H2>

<form action="AnswerSubmitServ">
<input type="hidden" name=queId value=<%=queId %>><br>
<textarea rows="10" cols="60" name=value placeholder="Write here......."></textarea><br>
